...
export default Vue.extend({
  ...
  async mounted() {
    ...
    term.writeln('\n');
    term.writeln('Welcome to K-OS 7.0.0 LTS (K-OS/Linux 7.4.0-52-generic x86_64)');
    term.writeln('\n');
  ...
  methods: {
    async startTextSequence() {
      ...
      await this.typeTextLn("I'm a software engineer who loves to compose music, make art, and craft video games.\n", 0.02);
    ...
    async parseCommand(cmd: string) {
      ...
      switch (args[0].toLowerCase()) {
        ...
        case "about":
          term.writeln(`
Passionate about programming, music, art, and game development, I create video games, compose music, and build companies.
...
I also love 3D printing, and I have a knack for creating 3D models. I also love making animations!
...
`);
        ...
        case "freshprints":
          await this.typeTextLn("Royce is proud of you right now!", 0.025, 0.025);
          await this.sleep(1);
          window.open("https://freshprints.gg");
          return;
        ...
        case "discord":
          await this.typeTextLn("Feel free to reach out! @navidk0", 0.025, 0.025);
          return;
...
-- Alive Games --
freshprints: A game about guessing the prompt of an AI generated image, and then guessing if it's actually AI or not!
